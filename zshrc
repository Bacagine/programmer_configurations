...
export DEBFULLNAME="Gustavo Bacagine"
export DEBEMAIL="gustavo.bacagine@protonmail.com"
export EDITOR=vim
export LANG=C.UTF-8
export LANGUAGE=C.UTF-8
export LC_ALL=C.UTF-8
#export QUILT_PATCHES=debian/patches
export FATEC=$HOME/FATEC
...
#╰─%B$%b "
#export CLASSPATH=/path/mysql-connector-java-8.0.29.jar:$CLASSPATH
...
alias nano="printf '\033[1;31mE:\033[m trash text editor identified!\nPlease use the vim editor =)\n'"
...
#xprop -format _NET_WM_WINDOW_OPACITY 32c -set _NET_WM_WINDOW_OPACITY 0xDFFFFFFF
